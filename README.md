...
<p>Результаты тестирования приведены ниже</p>
<table>
  <tr>
    <td>Улучшенная запись</td><td>Зашумленная запись</td>
  </tr>
  <tr>
    <td><audio src = 'audios/airplane2_42cb09faadd11female_enhanced.wav'>audio1</audio></td>
    <td><audio src = 'audios/airplane2_42cb09faadd11female_noisy.wav'>audio1</audio></td>
  </tr>
